...
func verify_schnorr_signature{output_ptr : felt*, range_check_ptr, bitwise_ptr : BitwiseBuiltin*, ec_op_ptr: EcOpBuiltin*}(alpha_G : EcPoint, response : felt, public_key : EcPoint){
    alloc_locals;
    ...
    let (_challenge) = uint256_to_felt(x = r);
    serialize_word(_challenge);
